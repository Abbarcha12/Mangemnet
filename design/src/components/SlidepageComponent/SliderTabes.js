...
import DbEmail from '../DbComponents/DbEmail'
...
import ProductSelect from '../ProductsPageComponent/ProductSelect';
import TextIcons from '../AlternativePageComponent/TextIcons';
import Add from "../All/Buttons//Add/Add"
// import { Input } from 'antd';
const { Search } = Input;
const { TextArea } = Input;
function SliderTabes() {
    return (
        <div>
